...
int d = 100; // Delay variable for multiplexing (in milliseconds). Change to adjust duty cycle
...
void loop() {
  ...
  digitalWrite(nixiepins[1], HIGH); // Display first tube with first number
